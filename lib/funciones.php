 ...
 */
function enviar_correo($nombreDestinatario, $emailDestinatario, $asunto, $contenido, $fichero='', $nombreRemitente = '', $emailRemitente = '', $servidorCorreo = '', $usuarioCorreo = '', $passwordCorreo = '', $puerto = '') {
